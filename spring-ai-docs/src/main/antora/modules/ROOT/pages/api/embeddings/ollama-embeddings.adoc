...
NOTE: The `spring-ai-ollama` dependency provides access also to the `OllamaChatConnector`.
For more information about the `OllamaChatConnector` refer to the link:../chat/ollama-chat.html[Ollama Chat Client] section.
