...
NOTE: The `spring-ai-mistral-ai` dependency provides access also to the `MistralAiChatConnector`.
For more information about the `MistralAiChatConnector` refer to the link:../chat/mistralai-chat.html[MistralAI Chat Client] section.
