...
NOTE: The `spring-ai-openai` dependency provides access also to the `OpenAiChatConnector`.
For more information about the `OpenAiChatConnector` refer to the link:../chat/openai-chat.html[OpenAI Chat Client] section.
