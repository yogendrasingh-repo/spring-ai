...
String result = chatCall.call(Map.of)  //User map
String result = chatCall.call(Map.of, Map.of)  //User and System map
String result = chatCall.call("user message", Map.of);
String result = chatCall.call("user message", Map.of, "system message", Map.of);
<T> T result  = chatCall.call("user message", Map.of, Class<T> returnType)
<T> T result  = chatCall.call("user message", Map.of, Class<T> returnType, "system message", Map.of)
