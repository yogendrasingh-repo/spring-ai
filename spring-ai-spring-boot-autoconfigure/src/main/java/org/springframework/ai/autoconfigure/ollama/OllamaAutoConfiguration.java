...
import org.springframework.ai.ollama.OllamaChatConnector;
...
public class OllamaAutoConfiguration {
	...
	@ConditionalOnProperty(prefix = OllamaChatProperties.CONFIG_PREFIX, name = "enabled", havingValue = "true",
			matchIfMissing = true)
	public OllamaChatConnector ollamaChatClient(OllamaApi ollamaApi, OllamaChatProperties properties) {
		return new OllamaChatConnector(ollamaApi, properties.getOptions());
	}
