...
public class BedrockAi21Jurassic2ChatAutoConfigurationIT {
	...
	public void chatCompletion() {
		contextRunner.run(context -> {
			BedrockAi21Jurassic2ModelCaller ai21Jurassic2ChatClient = context
				.getBean(BedrockAi21Jurassic2ModelCaller.class);
	...
	public void chatCompletionDisabled() {
		...
		new ApplicationContextRunner()
			...
			.run(context -> {
				...
				assertThat(context.getBeansOfType(BedrockAi21Jurassic2ModelCaller.class)).isEmpty();
			});
		...
		new ApplicationContextRunner().withPropertyValues("spring.ai.bedrock.jurassic2.chat.enabled=true")
			...
			.run(context -> {
				...
				assertThat(context.getBeansOfType(BedrockAi21Jurassic2ModelCaller.class)).isNotEmpty();
			});
