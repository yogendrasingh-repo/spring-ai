	...
	public void chatCompletionDisabled() {
		...
		new ApplicationContextRunner()
			...
			.run(context -> {
				...
				assertThat(context.getBeansOfType(BedrockAi21Jurassic2ChatConnector.class)).isEmpty();
			});
		...
		new ApplicationContextRunner().withPropertyValues("spring.ai.bedrock.jurassic2.chat.enabled=true")
			...
			.run(context -> {
				...
				assertThat(context.getBeansOfType(BedrockAi21Jurassic2ChatConnector.class)).isNotEmpty();
			});
