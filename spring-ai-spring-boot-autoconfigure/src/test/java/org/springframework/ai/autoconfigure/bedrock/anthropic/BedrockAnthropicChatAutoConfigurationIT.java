...
public class BedrockAnthropicChatAutoConfigurationIT {
	...
	public void chatCompletion() {
		contextRunner.run(context -> {
			BedrockAnthropicModelCall anthropicChatClient = context.getBean(BedrockAnthropicModelCall.class);
	...
	public void chatCompletionDisabled() {
		...
		new ApplicationContextRunner()
			...
			.run(context -> {
				...
				assertThat(context.getBeansOfType(BedrockAnthropicModelCall.class)).isEmpty();
			});
		...
		new ApplicationContextRunner().withPropertyValues("spring.ai.bedrock.anthropic.chat.enabled=true")
			...
			.run(context -> {
				...
				assertThat(context.getBeansOfType(BedrockAnthropicModelCall.class)).isNotEmpty();
			});
