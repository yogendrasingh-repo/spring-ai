...
public class BedrockAnthropicChatAutoConfigurationIT {
	...
	public void chatCompletion() {
		contextRunner.run(context -> {
			BedrockAnthropicModelCaller anthropicChatClient = context.getBean(BedrockAnthropicModelCaller.class);
	...
	public void chatCompletionDisabled() {
		...
		new ApplicationContextRunner()
			...
			.run(context -> {
				...
				assertThat(context.getBeansOfType(BedrockAnthropicModelCaller.class)).isEmpty();
			});
		...
		new ApplicationContextRunner().withPropertyValues("spring.ai.bedrock.anthropic.chat.enabled=true")
			...
			.run(context -> {
				...
				assertThat(context.getBeansOfType(BedrockAnthropicModelCaller.class)).isNotEmpty();
			});
